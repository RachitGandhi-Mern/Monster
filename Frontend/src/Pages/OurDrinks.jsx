...
//   return (
//     <div className="bg-[#FFF8F0] px-12 py-8">
//       <div className="max-w-[1400px] mx-auto border border-black">
//         <h2 className="text-[44px] font-bold px-4 font-[JoganSoft]">
//           Our Drinks
//         </h2>

//         <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x border-t border-black bg-white">
//           {drinks.map((item, index) => (
//             <div
//               key={index}
//               onMouseEnter={() => setHoveredIndex(index)}
//               onMouseLeave={() => setHoveredIndex(null)}
//               className="p-6 flex flex-col items-center gap-4 transition-all duration-300 ease-in-out"
//               style={{
//                 backgroundImage:
...
//                 src={item.img}
//                 alt={item.title}
//                 className={`w-[200px] object-contain transition-opacity  ease-in-out ${
...
//                 <span
//                   className={`text-2xl font-bold  transition-colors duration-300 font-[monster-energy] ${
...
//                 <button className="relative group px-6 py-2 text-white text-sm font-semibold rounded-full overflow-hidden hover:text-[#95D600] bg-black z-10">
//                   <span className="relative z-20 flex items-center gap-2 transition-all duration-300 group-hover:gap-3 ">
